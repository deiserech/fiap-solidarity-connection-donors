...
public class UserServiceTests
{
    ...
    {
        // Arrange
        var user = new User { Id = Guid.NewGuid(), Name = "U", Email = "u@x.com", Role = UserRole.Donor };
    ...
    {
        // Arrange
        var user = new User { Id = Guid.NewGuid(), Name = "U2", Email = "u2@x.com", Cpf = "12345678901", Role = UserRole.Donor };
    ...
    {
        var existing = new User { Id = Guid.NewGuid(), Name = "Old", Email = "old@x.com", Cpf = "12345678901", Role = UserRole.Donor };
    ...
    {
        var donor = new User { Id = Guid.NewGuid(), Name = "D", Email = "d@x.com", Cpf = "12345678901", Role = UserRole.Donor, IsActive = true };
        var svc = CreateService();
    ...
    public async Task GetAllAsync_DelegatesToRepository()
    {
        ...
        var users = new[]
        {
            new User { Id = Guid.NewGuid(), Name = "U1", Email = "u1@x.com", Role = UserRole.Donor },
            new User { Id = Guid.NewGuid(), Name = "U2", Email = "u2@x.com", Role = UserRole.Donor }
        };
